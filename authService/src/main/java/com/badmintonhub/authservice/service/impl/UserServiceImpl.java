...
import com.badmintonhub.authservice.dto.mapper.UserMapper;
...
public class UserServiceImpl implements UserService {
    ...
    @Override
    public UserDTO getUserByUsername(String username) throws APIException {
        User user = this.userRepository.findByUsername(username)
                .orElseThrow(() -> new APIException("Không tìm thấy user với username = " + username));
        return this.userMapper.mapToDto(user);
    }
}
