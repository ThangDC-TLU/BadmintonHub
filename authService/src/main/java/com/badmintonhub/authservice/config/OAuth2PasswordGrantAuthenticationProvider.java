...
public class OAuth2PasswordGrantAuthenticationProvider implements AuthenticationProvider {
    ...
    public OAuth2PasswordGrantAuthenticationProvider(OAuth2AuthorizationService authorizationService, OAuth2TokenGenerator<? extends OAuth2Token> tokenGenerator, AuthenticationManager authenticationManager) {
